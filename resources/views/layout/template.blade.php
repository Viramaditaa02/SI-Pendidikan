    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SI-PENDIDIKAN </div>
            </a>
          ...
          <hr class="sidebar-divider my-0">
            ...
            <a class="nav-link" href="{{ route('kelas') }}">
              <i class="ti-user menu-icon"></i>
              <span class="menu-title">Informasi Mapel</span>
            </a>
          </li>
          ...
          <hr class="sidebar-divider my-0">
            ...
            <a class="nav-link" href="{{ route('kelas') }}">
              <i class="ti-user menu-icon"></i>
              <span class="menu-title">Informasi Penilaian</span>
            </a>
          </li>
          <hr class="sidebar-divider my-0">
            <li class="nav-item">
            <a class="nav-link" href="{{ route('kelas') }}">
              <i class="ti-user menu-icon"></i>
              <span class="menu-title">Informasi Wali Murid</span>
            </a>
          </li>
          <hr class="sidebar-divider my-0">
            <li class="nav-item">
